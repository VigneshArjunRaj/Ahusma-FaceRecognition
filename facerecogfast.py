...
def faceDetect(test):
    ...
    haar=cv.CascadeClassifier("\\output\\haarcascade_frontalface_alt2.xml")
...
def Recognizer():
    ...
    #face_recog.save("\\traindata.xml")
    face_recog.read("\\traindata.xml")
    return face_recog
if __name__=="__main__":
 while(True):   
  ...
  names={0:"Vignesh Arjun Raj",1:"Rajesh",2:"Lakshmi"}
